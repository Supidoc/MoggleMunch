...
namespace MoggleMunch {
    public class ScoreBoard : IScoreboard {
        ...
        {
            get{List<ScoreBoardData> scoreBoard = GetScoreboard();
        ...
        /// exists.</remarks>
        /// <param name="playerName">The name of the player. Cannot be <see langword="null"/> or empty.</param>
        ...
        public void SetScore(string playerName, int score, int timeStamp)
        {
            ...
            if (timeStamp < 0)
            {
                throw new ArgumentException("invalid negativ time stamp");
            }
